...
var vec__32663 = axis;
var a_x = cljs.core.nth.call(null,vec__32663,(0),null);
var a_y = cljs.core.nth.call(null,vec__32663,(1),null);
var a_z = cljs.core.nth.call(null,vec__32663,(2),null);
var vec__32666 = v;
var x = cljs.core.nth.call(null,vec__32666,(0),null);
var y = cljs.core.nth.call(null,vec__32666,(1),null);
var z = cljs.core.nth.call(null,vec__32666,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__32669,p__32670){
var vec__32671 = p__32669;
var u1 = cljs.core.nth.call(null,vec__32671,(0),null);
var u2 = cljs.core.nth.call(null,vec__32671,(1),null);
var u3 = cljs.core.nth.call(null,vec__32671,(2),null);
var vec__32674 = p__32670;
var v1 = cljs.core.nth.call(null,vec__32674,(0),null);
var v2 = cljs.core.nth.call(null,vec__32674,(1),null);
var v3 = cljs.core.nth.call(null,vec__32674,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__32677_SHARP_){
return (p1__32677_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__32678_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__32679_SHARP_,angle_lr),angle_ud);
...
var map__32681 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__32681__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__32681__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__5455__auto__ = (function (){var pred__32683 = cljs.core._EQ_;
var expr__32684 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__32683.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__32684))){
return straight;
} else {
if(cljs.core.truth_(pred__32683.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__32684))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__32683.call(null,quil.middlewares.navigation_3d.space,expr__32684))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__32683.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__32684))){
return up;
} else {
if(cljs.core.truth_(pred__32683.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__32684))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__32683.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__32684))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__5455__auto__,map__32681,map__32681__$1,up,straight){
return (function (p1__32680_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__32680_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__5455__auto__,map__32681,map__32681__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__32686_SHARP_);
});})(initial_state))
);
});
/**
...
var map__32687_32698 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__32687_32699__$1 = ((((!((map__32687_32698 == null)))?((((map__32687_32698.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__32687_32698.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__32687_32698):map__32687_32698);
var vec__32688_32700 = cljs.core.get.call(null,map__32687_32699__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_32701 = cljs.core.nth.call(null,vec__32688_32700,(0),null);
var c_y_32702 = cljs.core.nth.call(null,vec__32688_32700,(1),null);
var c_z_32703 = cljs.core.nth.call(null,vec__32688_32700,(2),null);
var vec__32691_32704 = cljs.core.get.call(null,map__32687_32699__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_32705 = cljs.core.nth.call(null,vec__32691_32704,(0),null);
var u_y_32706 = cljs.core.nth.call(null,vec__32691_32704,(1),null);
var u_z_32707 = cljs.core.nth.call(null,vec__32691_32704,(2),null);
var vec__32694_32708 = cljs.core.get.call(null,map__32687_32699__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_32709 = cljs.core.nth.call(null,vec__32694_32708,(0),null);
var p_y_32710 = cljs.core.nth.call(null,vec__32694_32708,(1),null);
var p_z_32711 = cljs.core.nth.call(null,vec__32694_32708,(2),null);
quil.core.camera.call(null,p_x_32709,p_y_32710,p_z_32711,(p_x_32709 + c_x_32701),(p_y_32710 + c_y_32702),(p_z_32711 + c_z_32703),u_x_32705,u_y_32706,u_z_32707);
...
//# sourceMappingURL=navigation_3d.js.map?rel=1515667543072
