...
return (new CustomEvent(event_name,(function (){var obj37760 = {"detail":data};
return obj37760;
})()));
} else {
...
var f = (function (){var pred__37767 = cljs.core._EQ_;
var expr__37768 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__37767.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__37768))){
return ((function (pred__37767,expr__37768){
return (function (p1__37761_SHARP_){
return console.warn(p1__37761_SHARP_);
});
;})(pred__37767,expr__37768))
} else {
if(cljs.core.truth_(pred__37767.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__37768))){
return ((function (pred__37767,expr__37768){
return (function (p1__37762_SHARP_){
return console.debug(p1__37762_SHARP_);
});
;})(pred__37767,expr__37768))
} else {
if(cljs.core.truth_(pred__37767.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__37768))){
return ((function (pred__37767,expr__37768){
return (function (p1__37763_SHARP_){
return console.error(p1__37763_SHARP_);
});
;})(pred__37767,expr__37768))
} else {
return ((function (pred__37767,expr__37768){
return (function (p1__37764_SHARP_){
return console.log(p1__37764_SHARP_);
});
;})(pred__37767,expr__37768))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__37771){
...
var opts = map__37772__$1;
var eval_fn = cljs.core.get.call(null,map__37772__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__37774_SHARP_);
});})(new_def))
);
...
return (function (p__37775){
var vec__37776 = p__37775;
var ky = cljs.core.nth.call(null,vec__37776,(0),null);
var v = cljs.core.nth.call(null,vec__37776,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1515667568401
